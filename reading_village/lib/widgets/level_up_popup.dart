                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: buildingTypes.map((type) {
                          final max = GameConstants.maxBuildingsOfTypeForPlayerLevel(type, level);
                          final prevMax = GameConstants.maxBuildingsOfTypeForPlayerLevel(type, level - 1);
                          final increased = max > prevMax;
                          final template = GameConstants.findTemplate(type);
