...
class _GuessAuthorScreenState extends State<GuessAuthorScreen> {
  ...
  static const int _winsNeeded = 10;
  static const int _cooldownHours = 4;
  ...
  Future<void> _loadQuestions() async {
    final jsonStr = await rootBundle.loadString('assets/data/guess_author.json');
  ...
  void _nextQuestion() {
    ...
    // Avoid repeating questions during a streak
    ...
    final options = [question['correct_author'] as String, ...wrongAuthors.take(3)];
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  _currentQuestion!['book'] as String,
                  style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                    color: AppTheme.darkText,
          ...
          Flexible(
            child: Text(
              _isCorrect!
                  ...
                  : 'Wrong! The answer was: ${_currentQuestion!['correct_author']}',
              style: TextStyle(
                fontSize: 14,
              fontWeight: FontWeight.bold,
              color: _isCorrect! ? const Color(0xFF2E7D32) : Colors.red.shade400,
