...
class VillagerComponent extends PositionComponent with TapCallbacks {
  ...
  VillagerComponent({
    ...
    this.onTapped,
          ...
          position: position,
          size: Vector2(UiConstants.tilePixelSize * 0.38, UiConstants.tilePixelSize * 0.50),
  ...
  void _pickNewTarget() {
    final currentTileX =
        (position.x / UiConstants.tilePixelSize).floor();
    final currentTileY =
        (position.y / UiConstants.tilePixelSize).floor();
    ...
    _targetPosition = Vector2(
      target.$1 * UiConstants.tilePixelSize +
          UiConstants.tilePixelSize / 2,
